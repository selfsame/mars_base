...
(function() {
  ...
  $(window).ready(function() {
    var AxisNum, CallPoint, ESCAPE, EntityRef, RegisterStack, Scripted, SlowException, SlowParser, Vect2D;
    window.Scripter = {
      init: function() {
        var i, _i;
        this.watch = false;
      ...
      SlowParser.prototype.calculate = function(tokens, top) {
        ...
        for (i = _j = 0, _len1 = tokens.length; _j < _len1; i = ++_j) {
          ...
          if (!valid) {
            ...
            if (typeof value === 'object' && value.type === 'v') {
              ...
              } else if (typeof next === 'object' && next.type === 'axisnum') {
                if (operator === '+') {
