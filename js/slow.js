...
(function() {
  ...
  $(window).ready(function() {
    var CallPoint, ESCAPE, Scripted, SlowException, SlowParser;
    window.Scripter = {
      init: function() {
        var i, _i;
        this.watch = false;
    ...
    SlowParser = (function() {
      ...
      SlowParser.prototype.run_statement = function(line) {
        ...
        if ((result.escape != null) || (result.error != null)) {
          return result;
        } else {
          if (this.assign) {
        ...
        for (i = _j = 0, _len1 = tokens.length; _j < _len1; i = ++_j) {
          ...
          if (value === void 0) {
            if (!valid) {
              ...
              if ((value.error != null) || (value.escape != null)) {
                return value;
              }
              valid = true;
            } else {
            ...
            if ((next.error != null) || (next.escape != null)) {
              return next;
            }
            if (next != null) {
              if (operator === '+') {
